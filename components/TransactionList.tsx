    ...
    switch (category) {
      case 'Food & Dining':
        return (
          ...
          <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="m16 2-2.3 2.3a3 3 0 0 0 0 4.2l1.8 1.8a3 3 0 0 0 4.2 0L22 8" />
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15 15 3.3 3.3a4.2 4.2 0 0 0 0 6l7.3 7.3c.7.7 2 .7 2.8 0L15 15Zm0 0 7 7" />
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="m2.1 21.8 6.4-6.3" />
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="m19 5-7 7" />
          </svg>
        );
      case 'Shopping':
        return (
      ...
      case 'Transportation':
        return (
          // Car
          <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M8.25 18.75a1.5 1.5 0 01-3 0m3 0a1.5 1.5 0 00-3 0m3 0h6m-9 0H3.375a1.125 1.125 0 01-1.125-1.125V14.25m17.25 4.5a1.5 1.5 0 01-3 0m3 0a1.5 1.5 0 00-3 0m3 0h1.125c.621 0 1.129-.504 1.09-1.124a17.902 17.902 0 00-3.2-8.543c-1.04-1.583-2.353-2.743-3.82-3.415-1.616-.74-3.554-1.168-5.695-1.168H5.625c-.621 0-1.125.504-1.125 1.125v1.5c0 .621.504 1.125 1.125 1.125h1.5" />
          </svg>
        );
      case 'Health':
      case 'Medical':
