...
const TypewriterBrand: React.FC<TypewriterBrandProps> = ({ className = "", large = false, animate = true }) => {
  ...
  if (large) {
    return (
      <div className={`flex flex-row md:flex-col justify-center lg:justify-start items-baseline md:items-start pr-2 md:pr-0 ${className}`}>
        ...
        <h1 className="text-4xl sm:text-5xl md:text-7xl font-black tracking-tighter uppercase italic leading-none flex items-center pr-8 md:pr-10">
