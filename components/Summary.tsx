  ...
  return (
    ...
    >
      <motion.div variants={item}>
        <GlassCard className="border-l-4 border-l-indigo-500 group">
          <div className="flex items-center gap-2">
            ...
            <p className="text-sm text-slate-400 uppercase tracking-wider font-bold">Total Balance</p>
          </div>
          <div className="flex items-baseline gap-1 mt-1">
            <AnimatedNumber value={balance} prefix={config.symbol} className="text-3xl font-black text-white" />
          </div>
        </GlassCard>
      </motion.div>

      <motion.div variants={item}>
        <GlassCard className="border-l-4 border-l-emerald-500 group">
          <div className="flex items-center gap-2">
            ...
            <p className="text-sm text-slate-400 uppercase tracking-wider font-bold">Total Income</p>
          </div>
          <div className="flex items-baseline gap-1 mt-1">
            <AnimatedNumber value={totalIncome} prefix={config.symbol} className="text-3xl font-black text-emerald-400" />
          </div>
        </GlassCard>
      </motion.div>

      <motion.div variants={item}>
        <GlassCard className="border-l-4 border-l-rose-500 group">
          <div className="flex items-center gap-2">
            ...
            <p className="text-sm text-slate-400 uppercase tracking-wider font-bold">Total Expenses</p>
          </div>
          <div className="flex items-baseline gap-1 mt-1">
            <AnimatedNumber value={totalExpense} prefix={config.symbol} className="text-3xl font-black text-rose-400" />
          </div>
        </GlassCard>
      </motion.div>
    </motion.div>
