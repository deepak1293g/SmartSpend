          ...
          <GlassCard title="Danger Zone" className="border-rose-500/20 bg-rose-500/5">
            ...
            <div className="space-y-4">
              ...
              <button
                ...
                className="w-full py-4 rounded-xl bg-white/5 hover:bg-rose-500/40 border border-white/5 text-slate-500 hover:text-white font-black uppercase tracking-widest text-xs transition-all disabled:opacity-50 flex items-center justify-center gap-2 group"
              >
                <svg className="w-5 h-5 flex-shrink-0 text-slate-600 group-hover:text-rose-400 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.5" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16" /></svg>
